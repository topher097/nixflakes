  ...
  config = lib.mkIf cfg.battery.enable {
    ...
    services.tlp = {
      ...
      settings = {
        ...
        STOP_CHARGE_THRESH_BAT0 = 90; # Don't charge to 100% to preserve battery health. See https://www.samsung.com/semiconductor/minisite/ssd/product/consumer/970evo-plus/ for more info.
      };
    };
  };
}